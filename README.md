# Academic Class & Timetable Scheduling System

Timetable management application preventing room conflicts, assigning faculty to course slots, and organizing classroom schedules with SQLite.
...
- **Technologies**: Python 3.11, Tkinter, SQLite3
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-class-scheduling-sqlite.git
   cd masa-class-scheduling-sqlite
   ```
